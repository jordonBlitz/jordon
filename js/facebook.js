 ...
 * @version     $Id: custom.js 40 2014-05-04 23:36:58Z hire@bizlogicdev.com $
 *
			...
			$.ajax({
				...
				success: function( response, textStatus, jqXHRresponse ) {
					...
					if( response.status == 'OK' ) {
						...
						$('#frmErrors').html('<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> '+ fetchTranslation('authentication_failure') +'</div>')
						$.unblockUI();
					}
				},
